...
class CarWashStation:
    ...
    def calculate_washing_price(self, car):
        cost_of_single_wash = (car.comfort_class * (self.clean_power - car.clean_mark) * self.average_rating / self.distance_from_city_center)
        return round(cost_of_single_wash, 1)
